...
role_ccpaa = config.get('S3-Role', 'ccparolenw')
...
s3_staging_dir_new = "s3://aws-athena-query-results-171459160518-us-west-2"
                                    ...
                                    if (name == 'SlingID'):
                                        ...
                                        if ViwershipID != " ":
                                            ...
                                            if data != []:
                                                ...
                                                # awsconnection = aws_connection.s3_connection1(
                                                #     os.environ.get(
                                                ...
                                                #     config.get(
                                                #         'S3-Bucket',
                                                #         'destinationBucket1'),reportlocation,jobid
                                                #     ,keyobject)
