...
s3_staging_dir_new = "s3://aws-athena-query-results-171459160518-us-west-2/ccpa_file"
...
# athenaconn = athena_connection(
#     os.environ.get("aws_access_key_id"),
#     os.environ.get("aws_secret_access_key"), s3_staging_dir, region_name)


# athenaconn = athena_connection(os.environ.get("n_aws_access_key_id"),
#                                os.environ.get("n_aws_secret_access_key"),
#                                s3_staging_dir_new, region_name, role_arn_new)


athenaconn = athena_connection_without_role(
    os.environ.get("n_aws_access_key_id"),
    os.environ.get("n_aws_secret_access_key"), s3_staging_dir_new, region_name)



unloadquery = "select max(START_TIMESTAMP) from"
que= unloadquery + ' ' + tablename

print('*********************************************')
print("unloadqueryunloadqueryunloadquery", que)
cur = athenaconn
cur.execute(que)
print("####################################", cur.fetchall)
                                ...
                                for account_info in records2['request'][
                                    ...
                                    if (name == 'SlingID'):
                                        ...
                                        if ViwershipID != " ":
                                            ...
                                            print('jobidjobidjobidjobidjobid',jobid)
