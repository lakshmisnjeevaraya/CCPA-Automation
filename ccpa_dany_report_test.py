...
athenaconn=athena_connection(os.environ.get("aws_access_key_id"),os.environ.get("aws_secret_access_key"),s3_staging_dir, region_name, role_arn)
...
def ccpa_dany_request():
    ...
    tasklist = http_client.get_snow_api(base_url, query, assignment_id, Fields,
                                        CustomTool, user, passw,group,reporting_date)
            ...
            try:
                ...
                if len(cpa_guid) == 24:
                    ...
                    mongoresult = http_client.get_mongo_api(
                        mongoDB_uri, cpa_guid, CustomTool, task, os.environ.get(
                                                    "mongo_user"),group,reporting_date)
                            ...
                            if "actualRequestorProfile" in records2['request']:
                                ...
                                for account_info in records2['request'][
                                    ...
                                    if(provider_id == 'CSG-ACP'):
                                        ...
                                        if account_id != " ":
                                            query_to_chk_data = build_query.dany_athena_query(account_id,submissiondate,athenaconn,group,reporting_date)
                                            ...
                                            if dany_data != []:
                                                ...
                                                awsconnection = aws_connection.s3_connection_assumerole_danyrolw(
                                                    ...
                                                    config.get(
                                                        'S3-Bucket',
                                                        'destinationBucket'),
                                                    reportlocation, jobid, submissiondate,keyobject,group,reporting_date
                                                    )
                                                closetask = http_client.delete_task(
                                                    ...
                                                    config.get(
                                                        'State-Closurecode',
                                                        'Data Provided'),submissiondate,group,reporting_date)
                                            else:
                                                ...
                                                closetask = http_client.delete_task(
                                                    ...
                                                    config.get(
                                                        'State-Closurecode',
                                                        'No Data Found'), submissiondate, group,reporting_date)
                                ...
                                closetask = http_client.delete_task(
                                    ...
                                    sys_id, keyobject, user, passw,
                                    config.get('State-Closurecode', 'state'),
                                    config.get('State-Closurecode',
                                               'No Data Found'), submissiondate, group, reporting_date)
